...
export default function AppBuildingPage() {
    ...
    useEffect(() => {
        getPageContent<PageContent>("app_building").then(setContent);
    }, [i18n.language]);
            ...
            <main className="flex-grow pt-24">
                ...
                <section className="py-24 container">
                    <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                        ...
                        <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl bg-slate-100">
                            <img
                                src="/app-ecosystem.png"
                                alt="Scalable mobile app ecosystem illustration - BlockMarketing Consulting"
                ...
                <section className="py-24 bg-brand-dark relative overflow-hidden">
                    ...
                    <div className="container px-4 text-center relative z-10">
                        <h2 className="text-4xl md:text-6xl font-bold font-heading mb-6 tracking-tight text-white">Ready to build your app?</h2>
                        <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto">From MVP to scale. We build high-performance applications designed for growth.</p>
