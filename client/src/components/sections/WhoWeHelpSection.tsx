...
export default function WhoWeHelpSection({ content }: WhoWeHelpProps) {
    return (
        <section className="relative bg-[#262626] text-white pb-32 overflow-hidden">
            {/* Top wave divider connecting to previous section */}
            <div className="absolute top-0 left-0 w-full overflow-hidden leading-none rotate-180">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block h-[80px] w-[calc(100%+1.3px)] fill-[#FFF5F0]">
                ...
                <div className="grid md:grid-cols-3 gap-16 mb-20 max-w-5xl mx-auto">
                    {content.items.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="mb-8 text-orange-400 p-8 rounded-full border border-orange-500/20 bg-orange-500/5 group-hover:border-orange-500/50 group-hover:bg-orange-500/10 transition-all duration-500">
